...
import { createWarranty, getWarrantyByInvoice, updateWarranty, deleteWarranty } from "../service/warranty.service";
import { createWarrantySchema, updateWarrantySchema } from "../schemas/warranty.schema";
...
export const findByInvoice = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
